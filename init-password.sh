...
# URL
EXASTRO_PROTOCOL=${EXASTRO_PROTOCOL:-http}
EXASTRO_HOST=${EXASTRO_HOST:-localhost}
EXASTRO_PORT=${EXASTRO_PORT:-8080}
...
EXASTRO_PASSWORD=${EXASTRO_PASSWORD:-hogehoge}
EXASTRO_API_CREDENTIAL=$(echo -n "${EXASTRO_USERNAME}:${EXASTRO_PASSWORD}" | base64)

# cookie file
EXASTRO_COOKIE_FILE=./initialize-password-cookie.txt
